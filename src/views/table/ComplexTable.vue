<template>
  <div class="app-container">
    ...
    <el-pagination :total="total" v-show="total > 0" v-model:page="listQuery.page" v-model:limit="listQuery.limit" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage4" :page-sizes="[10, 20, 50, 100]" layout="total, sizes, prev, pager, next, jumper" />

    <el-dialog :title="textMap[dialogStatus]" v-model="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="tempArticleModel" label-position="left" label-width="100px" style="width: 400px; margin-left: 50px">
        ...
        <el-form-item :label="t('table.remark')">
          <el-input v-model="tempArticleModel.abstractContent" :autosize="{minRows: 2, maxRows: 4}" type="textarea" placeholder="Please input" />
        </el-form-item>
      </el-form>
